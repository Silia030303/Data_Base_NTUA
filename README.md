...
- **1.	INSERT:** Εισάγει νέες εγγραφές σε έναν πίνακα της βάσης δεδομένων.
- **2.	UPDATE:** Ενημερώνει τιμές σε υπάρχουσες εγγραφές ενός πίνακα.
- **3.	DELETE:** Διαγράφει εγγραφές από έναν πίνακα.
