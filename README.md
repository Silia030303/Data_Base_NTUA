...
**Ο κώδικας στο αρχείο Triggers.sql περιέχει εντολές που χρησιμοποιούνται βελτιστοποιούν τις επιδόσεις των ερωτημάτων, επιτρέποντας γρηγορότερη ανάκτηση δεδομένων μειώνοντας τον χρόνο αναζήτησης και τον αριθμό των απαιτούμενων δίσκων για πρόσβαση στα δεδομένα.**
